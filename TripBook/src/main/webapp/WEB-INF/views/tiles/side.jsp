		...
		<c:when test="${userState eq '0'}">
			<div id='sideNav'>
				<a class='sideProfileLink' href='<c:url value="/mypage/list"/>'>
					...
					</div> </a> <a href='<c:url value="/calendar/list"/>'>
					<div id="sideSchedule">
						<a href="<c:url value="/calendar/calendar"/>">
						<img alt="스케줄" src="<c:url value="/images/icon/icon_schedule48.png"/>" class="hover">
						<div class="text">스케줄</div>
					</div></a>
					<div id="sideHome">
						<a href='<c:url value="/main/main"/>'>
						<img alt="홈" src="<c:url value="/images/icon/icon_home48.png"/>" class="hover">
						<div class='text'>홈</div></a>
					</div>
					<div id="sideBiography">
						<a href='<c:url value="/biography/biography"/>'>
						<img alt="여행일대기" src="<c:url value="/images/icon/icon_tripbook48.png"/>" class="hover">
						<div class='text'>여행일대기</div></a>
					</div>
						 <a
					href='<c:url value="/friends/list"/>'><div id='sideFriend'>친구</div></a>
				<p>
				<div id='sideGroup'>

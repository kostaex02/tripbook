...
<body>
	<div id="container" class="container intro-effect-fadeout">
		<header class="header">
			<div class="bg-img">
				<img src='<c:url value="/images/background/tripBookLogin.png"/>' id="home-background" alt="Background Image" style="margin-top: -100px;"/>
			</div>
			<div class="title">
				...
				<form class="form-horizontal" method="post" action='<c:url value="/login"/>'
					...
					<div class="col-sm-6">
						...
						<input type="email" class="form-control" name="id" placeholder="Email" id="loginEmail">
					</div>
					</div>
					<div class="row">
					<div class="col-sm-6"></div>

...
<!-- Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <a href="#stack2" data-toggle="modal" data-keyboard="true"><img src='<c:url value="/images/img.jpg"/>' class="img-rounded" alt="Cinque Terre" width="260" height="200"></a>
          <a href="#stack2" data-toggle="modal"><img src='<c:url value="/images/img.jpg"/>' class="img-rounded" alt="Cinque Terre" width="260" height="200"></a>
          <a href="#stack2" data-toggle="modal"><img src='<c:url value="/images/img.jpg"/>' class="img-rounded" alt="Cinque Terre" width="260" height="200"></a>
          <a href="#stack2" data-toggle="modal"><img src='<c:url value="/images/img.jpg"/>' class="img-rounded" alt="Cinque Terre" width="260" height="200"></a>
        </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="stack2" role="dialog" tabindex='-1'>
    <div class="modal-dialog">
        ...
        <div class="modal-body">
    		...
    		<div class="carousel-inner" role="listbox">
      			<div class="item active">
        			<img src='<c:url value="/images/img.jpg"/>' class="img-rounded" alt="Chania" width="460" height="345">
      			</div>
